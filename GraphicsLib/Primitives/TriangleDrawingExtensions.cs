    ...
    public static class TriangleDrawingExtensions
    {
        ...
        )
        {
            ...
            if (min.Y == mid.Y)
            {
                ...
                bitmap.DrawПолигоныTopTriangleWithZBuffer(bitmapWidth, bitmapHeight, min, mid, max, color, zbuffer);
            }
            else if (max.Y == mid.Y)
            {
                //flat bottom
                ...
                bitmap.DrawПолигоныBottomTriangleWithZBuffer(bitmapWidth, bitmapHeight, min, mid, max, color, zbuffer);
            }
            else
            {
                ...
                if (interpolant.X > mid.X)
                {
                    ...
                    bitmap.DrawПолигоныBottomTriangleWithZBuffer(bitmapWidth, bitmapHeight, min, interpolant, mid, color, zbuffer);
                    bitmap.DrawПолигоныTopTriangleWithZBuffer(bitmapWidth, bitmapHeight, mid, interpolant, max, color, zbuffer);
                }
                else
                {
                    //left major
                    ...
                    //  
                    // max                      
                    bitmap.DrawПолигоныBottomTriangleWithZBuffer(bitmapWidth, bitmapHeight, min, mid, interpolant, color, zbuffer);
                    bitmap.DrawПолигоныTopTriangleWithZBuffer(bitmapWidth, bitmapHeight, interpolant, mid, max, color, zbuffer);
                }
            }

        }

        private static void DrawПолигоныTopTriangleWithZBuffer(this WriteableBitmap bitmap, int bitmapWidth, int bitmapHeight,
                    Vector4 leftTopPoint, Vector4 rightTopPoint, Vector4 bottomPoint, uint color, Zbuffer zbuffer)
        {
            ...
            bitmap.DrawПолигоныTriangleWithZBuffer(bitmapWidth, bitmapHeight, leftTopPoint, rightPoint, bottomPoint.Y,
                                                dLeftPoint, dRightPoint, dzdx, color, zbuffer);
        }
        private static void DrawПолигоныBottomTriangleWithZBuffer(this WriteableBitmap bitmap, int bitmapWidth, int bitmapHeight,
            Vector4 topPoint, Vector4 rightBottomPoint, Vector4 leftBottomPoint, uint color, Zbuffer zbuffer)
        {
            ...
            bitmap.DrawПолигоныTriangleWithZBuffer(bitmapWidth, bitmapHeight, topPoint, rightPoint,
        ...
        private static void DrawПолигоныTriangleWithZBuffer(this WriteableBitmap bitmap, int bitmapWidth, int bitmapHeight,
